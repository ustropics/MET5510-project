...
for n_mode = 1:12
    ...
    % Unpack params from calculated data file
    ...
    % Background state (only plot once since it's the same for all modes)
    if n_mode == 1
    ...
    fprintf('Mode %d plots generated successfully.\n', n_mode);
end

fprintf('\n========== All 12 modes plotted successfully ==========\n');
disp('Plots saved to:');
disp(params.plot_dir);