...
file_name = fullfile(params.data_dir, sprintf('data_wave_%d.mat', m0));

% Save all required variables
save(file_name, ...
    'Ubar', 'BPVy', 'eigVec', 'eigVal', 'eigVec2', 'eigVal2', ...
    'eigVec3', 'eigVal3', 'jj', 'kk', 'll', 'NN2', 'f0', 'dy', 'dz', 'm0', ...
    'Lx', 'beta', 'cplx', 'gg', 'Theta0', 'HH', 'B', 'C', 'D', 'model');

toc
disp_str = sprintf('All data computed and saved to %s', file_name);
disp(disp_str);