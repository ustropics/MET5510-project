...
% CONSTRUCT_MATRICES_BCD Constructs matrices B, C, D for PV inversion and advection
% Input: ll - Total number of linear indices
...
% Output: B - Matrix for PV inversion
