...
% Filename: hwme_bpvy.m

% Description: Initializes the potential vorticity gradient field (BPVy) for
% the Hoskins-West modified Eady-type model in the quasi-geostrophic framework,
% incorporating beta-plane dynamics and second derivatives of the mean zonal wind.
...
function BPVy = hwme_bpvy(jj, kk, beta, Ubar, dy, f0, NN2, dz)
