...
% PLOT_UBAR_WITH_EVEC_AMP
%   Filled contour of background zonal wind (Ubar) with
%   eigenvector amplitude plotted as black contour lines.
%
% INPUT
...
%
% OUTPUT
%   Saves:  fig_path/ubar_with_evec_amp_eMode-n_m0-m.png
    ...
    % colormap(cmap_magma(256));          % same colormap you used before
    cb1 = colorbar;
    ...
    %% --------------------------------------------------------------------
    % Choose a sensible number of levels (you can tweak this)
    ...
    fprintf('Saving Ubar + evec_amp plot to: %s\n', outFile);
    saveas(fig, outFile);
    close(fig);
