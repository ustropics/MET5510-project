...
function plot_temperature(xx, yy, temp, kk, model, m0, n_mode, fig_path)
    ...
    %% Save figure
    outFile = fullfile(fig_path, [model, '_temperature_', '_nmode-', num2str(n_mode), '_m0-', num2str(m0), '.png']);
    saveas(gcf, outFile);
    close(gcf);
