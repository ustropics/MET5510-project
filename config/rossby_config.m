...
% - rossby_data_dir: Directory for saving data
% - rossby_data_filename: Filename for saving data
% - rossby_plot_dir: Directory for saving plots
...
%% Directory variables
params.rossby_plot_dir = 'output/figures/'; % directory for saving plots
params.rossby_data_dir = 'output/data/'; % directory for saving data
params.rossby_data_filename = ['rossby_wave_', num2str(params.m0), '.mat']; % data filename
