...
fprintf('Loading computed data from %s for QG-CAI model and calculating parameters...\n', data)
...
%% Save computed fields for plotting
results = struct(...
    'gpt_h', gpt_h, ...
    'temp', temp, ...
    'ug', ug, ...
    ...
    'pvfield', pvfield, ...
    'wfield', wfield, ...
    'gpt_h_hovmoler1', gpt_h_hovmoler1, ...
    'gpt_h_hovmoler51', gpt_h_hovmoler51, ...
    'ug_hovmoler1', ug_hovmoler1, ...
    'ug_hovmoler51', ug_hovmoler51, ...
    'xx', xx, 'yy', yy, 'zz', zz, 'time', time, ...
    'Ubar', Ubar, 'BPVy', BPVy, 'XV', XV, ...
    'm0', m0, 'n_mode', n_mode, ...
    'growth_rate', growth_rate, 'omega', omega, ...
    'phase_speed', phase_speed, 'eFolding', eFolding, ...
    'hlat', hlat, 'params', params);

save(fullfile(params.data_dir, params.calc_filename), 'results');
