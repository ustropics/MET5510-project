...
LW = (jj+1)*(kk-1);
G  = build_elliptic_operator();

F3 = compute_forcing_F3(XV);
F2 = compute_forcing_F2(XV,Ubar);
F1 = compute_forcing_F1(XV,Ubar);

w_vec   = solve_vertical_velocity(G,F1,F2,F3);
